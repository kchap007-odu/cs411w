...
class TestDevices(unittest.TestCase):
    ...
    def test_set_status(self):
        """Test the ability to set statuses if valid and reject if not.
        """
    ...
    def test_set_from_json(self):
        """Test ability to set properties from JSON.
        """
